...
class main:
    ...
    def load(self):        
        ...
        ck.CTkLabel(load, text="copyright @rajat-jain-010", text_font=("Courier New",25), text_color="lime").place(relx=0.3, rely=0.05)
        ck.CTkLabel(load, text="010", text_font=("Courier New",25), text_color="lime").place(relx=0.42, rely=0.11)
